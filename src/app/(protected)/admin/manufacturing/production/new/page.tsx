...
export const metadata = {
    title: "Tambah Produksi Baru — Manufaktur",
    description: "Mulai sesi produksi baru barang jadi dari bahan baku konveksi.",
};
...
export default function AdminManufacturingProductionCreatePage() {
    return (
