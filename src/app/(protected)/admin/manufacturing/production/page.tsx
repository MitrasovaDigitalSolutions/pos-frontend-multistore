...
export const metadata = {
    title: "Produksi Harian — Manufaktur",
    description: "Kelola proses produksi harian barang jadi dari bahan baku konveksi.",
};
...
export default function AdminManufacturingProductionPage() {
    return (
