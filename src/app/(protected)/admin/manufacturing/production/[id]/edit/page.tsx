...
export const metadata = {
    title: "Edit Produksi — Manufaktur",
    description: "Ubah rincian produksi barang jadi dari bahan baku konveksi.",
};

function ProductionEditSkeleton() {
    return (
...
export default async function AdminManufacturingProductionEditPage({
    params,
}: {
    ...
    return (
        <Suspense fallback={<ProductionEditSkeleton />}>
            <ProductionCreatePage productionUid={id} />
        </Suspense>
    );
}
