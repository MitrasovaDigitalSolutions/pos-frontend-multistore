...
export const ENDPOINTS = {
    ...
    INVENTORY: {
        STOCK_TRANSFERS: {
            ...
            VALIDATIONS: "/v1/inventory/stock-transfers/validations",
            ...
            VALIDATE_ITEM: (uid: string, itemUid: string) => `/v1/inventory/stock-transfers/${uid}/items/${itemUid}/validate`,
        ...
        OPNAME: {
            ...
            FINALIZE: (uid: string) => `/v1/inventory/opname/${uid}/finalize`,
            ITEMS: (uid: string) => `/v1/inventory/opname/${uid}/items`,
            ITEM_UPDATE: (uid: string, itemUid: string) => `/v1/inventory/opname/${uid}/items/${itemUid}`,
            ITEM_DELETE: (uid: string, itemUid: string) => `/v1/inventory/opname/${uid}/items/${itemUid}`,
            PROGRESS: (uid: string) => `/v1/inventory/opname/${uid}/progress`,
            SCAN: (uid: string) => `/v1/inventory/opname/${uid}/scan`,
            SHEET_PDF: "/v1/inventory/opname/sheet/pdf",
            SHEET_XLSX: "/v1/inventory/opname/sheet/xlsx",
            IMPORT: "/v1/inventory/opname/import",
            IMPORT_INTO_DRAFT: (uid: string) => `/v1/inventory/opname/import/${uid}`,
        },
        SUPPLIERS: {
