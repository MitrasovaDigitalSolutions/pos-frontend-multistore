                    ...
                    <div className="space-y-3 sm:space-y-4 relative">
                        {sortedMovements.map((movement, idx) => {
                            ...
                            if (movement.type === "opening" || movement.type === "initial") {
                                iconElement = <IconLockOpen size={11} className="stroke-[2.5]" />;
                                ...
                                iconElement = <IconCash size={11} className="stroke-[2.5]" />;
                                ...
                                iconElement = <IconArrowDownLeft size={11} className="stroke-[2.5]" />;
                                ...
                                iconElement = <IconArrowUpRight size={11} className="stroke-[2.5]" />;
                                ...
                                iconElement = <IconLock size={11} className="stroke-[2.5]" />;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Event Card */}
                                    <div className="pl-6 sm:pl-8 w-full">
                                        <div className="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-850 rounded-xl p-2.5 sm:p-3.5 shadow-2xs hover:border-slate-200 dark:hover:border-slate-800 hover:shadow-xs transition-all duration-200">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
                                                ...
                                                <div className="space-y-1 sm:space-y-1.5 flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[11px] sm:text-xs font-bold text-slate-800 dark:text-slate-200 leading-normal" title={movement.note || getFallbackNote(movement.type)}>
                                                ...
                                                {/* Right cash display */}
                                                <div className="text-left sm:text-right flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2 sm:gap-1.5 border-t sm:border-none pt-2 sm:pt-0 border-slate-50 dark:border-slate-900/40 shrink-0">
                                                    <span className={cn(
                                                        "text-xs sm:text-sm font-black tabular-nums tracking-tight block",
                                                        isOutflow ? "text-rose-600 dark:text-rose-500" : "text-emerald-600 dark:text-emerald-450"
                                                    )}>
                                                        {isOutflow ? "-" : "+"} {formatRupiah(movement.amount)}
                                                    </span>
                                                    <span className="bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-450 text-[9px] font-bold px-1.5 py-0.5 rounded border border-slate-100/60 dark:border-slate-850 font-mono tracking-tight">
