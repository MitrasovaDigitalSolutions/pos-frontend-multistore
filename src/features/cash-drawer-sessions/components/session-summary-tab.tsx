        ...
        <div className="space-y-3.5 sm:space-y-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                <div className="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-850 shadow-xs rounded-xl p-2.5 sm:p-3.5 space-y-1 sm:space-y-1.5 hover:border-slate-200 transition-all">
                    ...
                    <div className="text-[10px] sm:text-xs font-black text-slate-800 dark:text-slate-200 truncate">
                ...
                <div className="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-850 shadow-xs rounded-xl p-2.5 sm:p-3.5 space-y-1 sm:space-y-1.5 hover:border-slate-200 transition-all">
                    ...
                    <div className="text-[10px] sm:text-xs font-black text-slate-800 dark:text-slate-200 flex items-center gap-1 truncate">
            ...
            <div className="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-850 rounded-2xl p-3.5 sm:p-5 shadow-xs space-y-3 sm:space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 sm:gap-2 pb-2 border-b border-slate-100 dark:border-slate-850">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[11px] sm:text-xs font-extrabold text-slate-800 dark:text-slate-200 uppercase tracking-wider">
                            Rekonsiliasi Kas Laci (Drawer Cash)
                        </span>
                    </div>
                    {session.status !== "open" && (
                        <span className={cn(
                            "text-[9px] sm:text-[10px] font-black px-2.5 sm:px-3 py-0.5 rounded-full border uppercase tracking-wide flex items-center gap-1 shadow-xs self-start sm:self-auto",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 sm:gap-4">
                    {/* Expected Cash */}
                    <div className="space-y-1 bg-slate-50/50 dark:bg-slate-900/20 border border-slate-100 dark:border-slate-850 p-3 sm:p-4 rounded-xl">
                        <span className="text-[9px] sm:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">
                            Ekspektasi Kas Sistem
                        </span>
                        <span className="text-lg sm:text-xl font-black text-slate-900 dark:text-slate-100 block tabular-nums tracking-tight">
                    ...
                    {/* Difference */}
                    <div className={cn(
                        "space-y-1 p-3 sm:p-4 rounded-xl border transition-colors",
                        ...
                        <span className={cn(
                            "text-[9px] sm:text-[10px] font-extrabold uppercase tracking-wider block",
                        ...
                        <span className={cn(
                            "text-lg sm:text-xl font-black block tabular-nums tracking-tight",
                            session.status === "open" ? "text-slate-400" :
                ...
                {session.status !== "open" && difference !== 0 && (
                    <div className={cn(
                        "p-3 sm:p-4 rounded-xl border flex gap-2.5 sm:gap-3 text-xs leading-relaxed shadow-xs",
                        ...
                        <IconAlertCircle size={16} className={cn("shrink-0 mt-0.5", difference < 0 ? "text-rose-500" : "text-teal-500")} />
                        <div>
                            {difference < 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="border border-slate-100 dark:border-slate-850 rounded-2xl shadow-xs bg-white dark:bg-slate-950 overflow-hidden">
                    <div className="bg-emerald-50/20 px-3.5 sm:px-4 py-3 border-b border-slate-100 dark:border-slate-850 flex items-center justify-between">
                        <span className="text-[11px] sm:text-xs font-extrabold text-emerald-800 dark:text-emerald-400 uppercase tracking-wider flex items-center gap-1.5">
                            <IconTrendingUp size={15} /> Aliran Kas Masuk (Inflow)
                        </span>
                        <span className="text-xs font-black text-emerald-700 dark:text-emerald-400 font-mono">
                            {formatRupiah(totalInflow)}
                        </span>
                    </div>
                    <div className="p-3 sm:p-4 space-y-2.5 sm:space-y-3 text-xs">
                        <div className="flex justify-between items-center text-slate-500 font-semibold text-[11px] sm:text-xs">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <span className="truncate">Modal Awal (Opening)</span>
                            </div>
                            <span className="text-slate-800 dark:text-slate-200 font-extrabold tabular-nums shrink-0 ml-1">
                                {formatRupiah(session.opening_balance)}
                            </span>
                        </div>
                        <div className="flex justify-between items-center text-slate-500 font-semibold border-t border-slate-50 dark:border-slate-900/40 pt-2 text-[11px] sm:text-xs">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <span className="truncate">Penjualan Tunai (Cash Sales)</span>
                            </div>
                            <span className="text-emerald-600 dark:text-emerald-450 font-extrabold tabular-nums shrink-0 ml-1">
                        ...
                        <div className="flex justify-between items-center text-slate-500 font-semibold border-t border-slate-50 dark:border-slate-900/40 pt-2 text-[11px] sm:text-xs">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <span className="truncate">Uang Masuk Lainnya (Cash In)</span>
                            </div>
                            <span className="text-emerald-600 dark:text-emerald-450 font-extrabold tabular-nums shrink-0 ml-1">
                ...
                {/* Cash Outflows Box */}
                <div className="border border-slate-100 dark:border-slate-850 rounded-2xl shadow-xs bg-white dark:bg-slate-950 overflow-hidden">
                    <div className="bg-rose-50/20 px-3.5 sm:px-4 py-3 border-b border-slate-100 dark:border-slate-850 flex items-center justify-between">
                        <span className="text-[11px] sm:text-xs font-extrabold text-rose-800 dark:text-rose-400 uppercase tracking-wider flex items-center gap-1.5">
                            <IconTrendingDown size={15} /> Aliran Kas Keluar (Outflow)
                        </span>
                    ...
                    <div className="p-3 sm:p-4 space-y-2.5 sm:space-y-3 text-xs">
                        <div className="flex justify-between items-center text-slate-500 font-semibold text-[11px] sm:text-xs">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <span className="truncate">Uang Keluar Operasional (Cash Out)</span>
                            </div>
                            <span className="text-rose-600 dark:text-rose-450 font-extrabold tabular-nums shrink-0 ml-1">
                        ...
                        <div className="flex justify-between items-center text-slate-500 font-semibold border-t border-slate-50 dark:border-slate-900/40 pt-2 text-[11px] sm:text-xs">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <span className="truncate">Refund Tunai (Cash Refund)</span>
                            </div>
                            <span className="text-rose-600 dark:text-rose-450 font-extrabold tabular-nums shrink-0 ml-1">
            ...
            <div className="bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-850 rounded-2xl p-3.5 sm:p-5 shadow-xs space-y-3 sm:space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 sm:gap-2 pb-2 border-b border-slate-100 dark:border-slate-850">
                    ...
                    <div className="flex gap-2">
                        <span className="text-[9px] sm:text-[10px] bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-800 font-bold px-2 py-0.5 rounded-full shadow-2xs">
                            {salesSummary.activeCount} Selesai
                        </span>
                        {salesSummary.voidedCount > 0 && (
                            <span className="text-[9px] sm:text-[10px] bg-rose-50 text-rose-600 border border-rose-100 font-bold px-2 py-0.5 rounded-full flex items-center gap-0.5 shadow-2xs">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                    {/* Gross Sales */}
                    <div className="bg-slate-50/30 dark:bg-slate-900/10 p-2.5 sm:p-3.5 rounded-xl border border-slate-100 dark:border-slate-850/80 space-y-1">
                        <span className="text-[9px] sm:text-[10px] font-extrabold text-slate-400 uppercase tracking-wide flex items-center gap-1">
                            <IconReceipt size={11} /> Penjualan Kotor
                        </span>
                        <span className="text-xs sm:text-base font-black text-slate-850 dark:text-slate-200 block tabular-nums truncate">
                    ...
                    <div className="bg-slate-50/30 dark:bg-slate-900/10 p-2.5 sm:p-3.5 rounded-xl border border-slate-100 dark:border-slate-850/80 space-y-1">
                        ...
                        <span className="text-xs sm:text-base font-black text-rose-600 dark:text-rose-400 block tabular-nums truncate">
                    ...
                    {/* Net Sales */}
                    <div className="bg-emerald-50/20 dark:bg-emerald-950/5 p-2.5 sm:p-3.5 rounded-xl border border-emerald-100/50 dark:border-emerald-900/20 space-y-1">
                        <span className="text-[9px] sm:text-[10px] font-extrabold text-emerald-800 dark:text-emerald-400 uppercase tracking-wide flex items-center gap-1">
                            <IconCheck size={11} /> Penjualan Bersih
                        </span>
                        <span className="text-xs sm:text-base font-black text-emerald-600 dark:text-emerald-450 block tabular-nums truncate">
                ...
                {totalPayments > 0 && (
                    <div className="space-y-2 pt-1 sm:pt-2">
                        <div className="flex justify-between items-center text-[9px] sm:text-[10px] font-bold text-slate-400">
                            ...
                            <span className="tabular-nums">{formatRupiah(totalPayments)}</span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2.5 sm:gap-4 text-[9px] sm:text-[10px] font-extrabold text-slate-500 dark:text-slate-400 pt-0.5">
                        ...
                        {(salesSummary.debtCashDpTotal > 0 || salesSummary.debtCardDpTotal > 0) && (
                            <div className="mt-2.5 p-2.5 sm:p-3 bg-slate-50/80 dark:bg-slate-900/40 rounded-xl border border-slate-150 dark:border-slate-800/80 text-[10px] sm:text-[11px] leading-relaxed text-slate-500 dark:text-slate-400">
                                ...
                                <ul className="list-disc list-inside mt-1 ml-1 space-y-0.5 font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="border border-slate-100 dark:border-slate-850 rounded-xl p-3 sm:p-4 bg-slate-50/20 dark:bg-slate-900/10 relative">
                    ...
                    <div className="relative pl-3 border-l-2 border-slate-200 dark:border-slate-800">
                        <p className="text-[11px] sm:text-xs font-semibold text-slate-600 dark:text-slate-400 leading-relaxed italic">
