...
import type { AccountingTutorialAutoFill } from "../types/accounting-tutorial";
...
export function CoaTutorialTooltip(props: TooltipRenderProps) {
    const stopTutorial = useAccountingTutorialStore((state) => state.stopTutorial);
    const [isFilling, setIsFilling] = useState(false);

    const step = props.step as unknown as { autoFill?: AccountingTutorialAutoFill; data?: { autoFill?: AccountingTutorialAutoFill } };
