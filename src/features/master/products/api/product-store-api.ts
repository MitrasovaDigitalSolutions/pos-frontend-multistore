...
export function useAssignProductStore() {
    ...
    return useMutation<
        ProductStore,
        Error,
        { productUid: string; store_uid: string; stok?: number; harga_beli?: number; harga_jual?: number; harga_grosir?: number | null; min_qty_grosir?: number | null; is_grosir?: boolean; margin?: number; status?: "active" | "inactive" }
    >({
...
export function useUpdateProductStore() {
    ...
    return useMutation<
        ProductStore,
        Error,
        { productUid: string; storeUid: string; stok?: number; harga_beli?: number; harga_jual?: number; harga_grosir?: number | null; min_qty_grosir?: number | null; is_grosir?: boolean; margin?: number; status?: "active" | "inactive" }
    >({
