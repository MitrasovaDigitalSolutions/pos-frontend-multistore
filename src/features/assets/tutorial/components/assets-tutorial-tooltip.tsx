...
import type { AssetTutorialAutoFill } from "../types/assets-tutorial";
...
export function AssetsTutorialTooltip(props: TooltipRenderProps) {
    const stopTutorial = useAssetsTutorialStore((state) => state.stopTutorial);
    const [isFilling, setIsFilling] = useState(false);

    const step = props.step as unknown as { autoFill?: AssetTutorialAutoFill; data?: { autoFill?: AssetTutorialAutoFill } };
