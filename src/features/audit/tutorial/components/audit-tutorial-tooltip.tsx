...
import type { AuditTutorialAutoFill } from "../types/audit-tutorial";
...
export function AuditTutorialTooltip(props: TooltipRenderProps) {
    const stopTutorial = useAuditTutorialStore((state) => state.stopTutorial);
    const [isFilling, setIsFilling] = useState(false);

    const step = props.step as unknown as { autoFill?: AuditTutorialAutoFill; data?: { autoFill?: AuditTutorialAutoFill } };
