...
import type { UsersTutorialAutoFill } from "../types/users-tutorial";
...
export function UsersTutorialTooltip(props: TooltipRenderProps) {
    const stopTutorial = useUsersTutorialStore((state) => state.stopTutorial);
    const [isFilling, setIsFilling] = useState(false);

    const step = props.step as unknown as { autoFill?: UsersTutorialAutoFill; data?: { autoFill?: UsersTutorialAutoFill } };
