                ...
                <Tabs defaultValue="all" className="w-full">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                        ...
                        <TabsList className="h-8 shrink-0">
                            <TabsTrigger value="all" className="text-[11px] px-3 font-semibold">
                                Semua
                            </TabsTrigger>
                            <TabsTrigger value="sale" className="text-[11px] px-3 font-semibold">
                                Penjualan
                            </TabsTrigger>
                            <TabsTrigger value="expense" className="text-[11px] px-3 font-semibold">
                                Pengeluaran
                            </TabsTrigger>
                        </TabsList>
                    </div>
