                                ...
                                {isLoading ? (
                                    ...
                                    <tr>
                                        <td colSpan={7} className="py-12 text-center">
                                            <div className="flex flex-col items-center gap-2 text-slate-300">
                                                ...
                                                <span className="text-xs text-slate-400 font-semibold">Belum ada transaksi offline.</span>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                    records.map((record) => {
                                        ...
                                        return (
                                            <tr
                                                key={record.uid}
                                                onClick={() => isSyncable && handleRowSelectToggle(record.uid)}
                                                className={cn(
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-2.5" onClick={(e) => e.stopPropagation()}>
                                                    {isSyncable ? (
                                                        <input
                                                            ...
                                                            className="w-3.5 h-3.5 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500 cursor-pointer"
                                                            checked={isChecked}
                                                            onChange={() => handleRowSelectToggle(record.uid)}
                                                        />
                                                    ) : (
                                                ...
                                                {/* UID */}
                                                <td className="px-3 py-2.5">
                                                    <span className="font-mono text-[9px] text-slate-500 block max-w-[80px] truncate" title={record.uid}>
                                                ...
                                                <td className="px-3 py-2.5">
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span className="text-[10px] font-semibold text-slate-700">{payment.label}</span>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-3 py-2.5">
                                                    ...
                                                    {record.status === "failed" && record.errorMessage && (
                                                        <div className="text-[8px] text-rose-500 mt-0.5 max-w-[120px] truncate" title={record.errorMessage}>
                                                            {record.errorMessage}
                                                        </div>
                                                    )}
                                                </td>
