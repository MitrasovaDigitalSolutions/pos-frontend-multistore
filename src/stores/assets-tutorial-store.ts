...
import type { AssetTutorialId } from "@/features/assets/tutorial/types/assets-tutorial";
...
interface AssetsTutorialStoreState {
    activeTutorial: AssetTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState;

    startTutorial: (id: AssetTutorialId) => void;
    stopTutorial: () => void;
...
export const useAssetsTutorialStore = create<AssetsTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
