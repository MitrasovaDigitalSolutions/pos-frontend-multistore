...
import type { HutangTutorialId } from "@/features/debts/tutorial/types/hutang-tutorial";
...
interface HutangTutorialStoreState {
    activeTutorial: HutangTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState | null;

    startTutorial: (id: HutangTutorialId) => void;
    stopTutorial: () => void;
...
export const useHutangTutorialStore = create<HutangTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
