...
import type { CashTutorialId } from "@/features/cash/tutorial/types/cash-tutorial";
...
interface CashTutorialStoreState {
    activeTutorial: CashTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState | null;

    startTutorial: (id: CashTutorialId) => void;
    stopTutorial: () => void;
...
export const useCashTutorialStore = create<CashTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
