...
import type { UsersTutorialId } from "@/features/users/tutorial/types/users-tutorial";
...
interface UsersTutorialStoreState {
    activeTutorial: UsersTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState;

    startTutorial: (id: UsersTutorialId) => void;
    stopTutorial: () => void;
...
export const useUsersTutorialStore = create<UsersTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
