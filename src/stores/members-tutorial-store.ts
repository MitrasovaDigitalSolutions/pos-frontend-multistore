...
import type { MembersTutorialId } from "@/features/master/members/tutorial/types/members-tutorial";
...
interface MembersTutorialStoreState {
    activeTutorial: MembersTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState;

    startTutorial: (id: MembersTutorialId) => void;
    stopTutorial: () => void;
...
export const useMembersTutorialStore = create<MembersTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
