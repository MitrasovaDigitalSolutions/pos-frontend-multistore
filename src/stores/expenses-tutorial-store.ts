...
import type { ExpensesTutorialId } from "@/features/expenses/tutorial/types/expenses-tutorial";
...
interface ExpensesTutorialStoreState {
    activeTutorial: ExpensesTutorialId | null;
    stepIndex: number;
    isRunning: boolean;
    isMenuOpen: boolean;
    cursor: CursorState | null;

    startTutorial: (id: ExpensesTutorialId) => void;
    stopTutorial: () => void;
...
export const useExpensesTutorialStore = create<ExpensesTutorialStoreState>((set) => ({
    activeTutorial: null,
    stepIndex: 0,
    isRunning: false,
    isMenuOpen: false,
