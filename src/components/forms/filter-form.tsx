            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto justify-end">
                        ...
                        <Button
                            type="submit"
                            className="bg-emerald-600 hover:bg-emerald-700 font-bold text-xs text-white h-10 rounded-xl px-4 gap-1.5 flex-1 sm:flex-initial"
                        >
                            {resolvedSubmitIcon}
                            {resolvedSubmitLabel}
                        </Button>
                ...
                {isExpanded && (
                    <>
                        ...
                        <div className="flex justify-end items-center gap-2 pt-3 border-t border-slate-100/50">
                            ...
                            <Button
                                type="submit"
                                className="bg-emerald-600 hover:bg-emerald-700 font-bold text-xs text-white h-9 rounded-xl px-4 gap-1.5"
                            >
                                {resolvedSubmitIcon}
                                {resolvedSubmitLabel}
                            </Button>
